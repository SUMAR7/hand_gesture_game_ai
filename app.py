...
def worker(input_q, output_q, cap_params, frame_processed):
    ...
    detection_graph, sess, category_index = detector_utils.load_inference_graph(num_classes, frozen_graph_path,
                                                                                label_path)
    ...
    while True:
        ...
        if (frame is not None):
            ...
            tags = detector_utils.get_tags(classes, category_index, num_hands_detect, score_thresh, scores, boxes,
                                           frame)
